<template>
    <div>
        ...
        <el-row style="margin-top:20px;margin-bottom:10px">
            <el-col :span=5 :offset=5>
                <el-select v-model="OptionValue">
                    <el-option v-for="item in options" :key="item.OptionValue" :label="item.label" :value="item.OptionValue"></el-option>
                </el-select>
            </el-col>
        </el-row>
        <!-- 审核 -->
        ...
        <div  v-if="OptionValue==0">
            ...
            <el-row v-for="(val, index) in ApplyList" type="flex" align="middle" style="margin-top:20px;margin-bottom:10px"  :key="index">
                <el-col :span=6 :offset=1>
                    <el-alert type="info" :closable="false" :title=val.message v-on:click.native="GoToReview(index)"></el-alert>
                </el-col>
                <el-col :span=8 :offset=1>
                    <td>
                        <el-button type="primary" @click="AgreeReview(index)">同意</el-button>
                        <el-button type="primary" @click="RejectReview(index)" style="margin-right:10px">拒绝</el-button>
                    </td>
                    <td>
        ...
        <!-- 审核弹框 -->
        <el-dialog title="审核详情" :visible.sync="ReviewDialogVisible" width="30%">
            <el-row>
                <el-col :span=12 :offset=6>
                    <p v-for="(val, key) in ApplyList[ApplyNumber].applyinfo">{{key}}： {{val}}</p>
                    <img v-if="ApplyList[ApplyNumber].applytype != 0" :src=ApplyList[ApplyNumber].url style="width:60px; height:60px; padding-left:0">
                    </br>
                    </br>
                    <el-button type="primary" @click="AgreeReview(ApplyNumber)">同意</el-button>
                    <el-button type="primary" @click="RejectReview(ApplyNumber)" style="margin-right:10px">拒绝</el-button>
                    </br>
                    </br>
                    <el-input v-model="RejectReason" placeholder="请输入拒绝原因"></el-input>
                </el-col>
        ...
        <div v-if="OptionValue==1">
            <el-row style="margin-top:20px;margin-bottom:10px">
                <el-col :span=4 :offset=1>
                    <el-input placeholder="请输入姓名/邮箱搜索" prefix-icon="el-icon-search" v-model="SearchInput"></el-input>
                </el-col>
            </el-row>
            <el-row style="margin-top:10px;margin-bottom:10px">
                <el-col :span=24 :offset=1>
                    <el-table :data="DistributionList" style="width:70%" v-if="OptionValue==1" stripe border>
                        ...
                        <el-table-column prop="RoleText" label="角色"  width="200"></el-table-column>
                        <el-table-column label="修改权限">
                            <template slot-scope="scope">
                                <el-button size="mini" type="primary" @click="GoToModify(scope.$index)">修改</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-col>
        ...
        <!-- 分配弹框 -->
        <el-dialog title="修改权限" :visible.sync="ModifyDialogVisible" width="15%">
            <el-row>
                <el-col :span=20 :offset=2>
                    ...
                    <el-button type="primary" @click="AgreeModify()" size="mini">确认</el-button>
                    <el-button type="primary" @click="CancelModify()" size="mini">取消</el-button>
                </el-col>
            </el-row>
        </el-dialog>
    </div>
