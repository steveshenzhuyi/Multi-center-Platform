<template>
    <div>
        <el-row :gutter=30 style="margin-top:40px;margin-bottom:10px">
            <!-- 图片+团队 -->
            <el-col :span=5 :offset=1>
                <div><img src="../../assets/AdminInfo/UserPhoto.png" style="width:100%; height:auto; padding:0; margin:0"></div>
                <br>
                <br>
                <div class="SubTitle"><i class="myIcon-qunzu"></i>  团队</div>
                <div>
                <ul><li v-for="(val, index) in team" @click="GoToTeam(index)">{{val}}</li></ul>
                </div>
            </el-col>
            <!-- 个人信息+重置密码 -->
            <el-col :span=6>
                ...
                <br>
                <p v-for="(val, key) in UserInfo" style="padding-left:10px">{{key}}： {{val}}</p>
                <br>
                <br>
                <div style="margin-left:18%"><el-button type="primary" @click="ResetPassword()">重置密码</el-button></div>
            </el-col>
            <!-- 通知 -->
            <el-col :span=6>
