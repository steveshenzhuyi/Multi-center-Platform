    ...
    <el-form ref="form"
      ...
      <div class="form-item"
        ...
        <el-form-item label="诊断编码集合">
          ...
          <!-- <el-checkbox v-model="form.formdetail[0].data2"
  ...
  class="except">不在其之间</el-checkbox> -->
    ...
    <div class="limit-condition"
      ...
      <label><input class="PriorDays num-input"
               type="number"
               min="0"
               v-model="form.formdetail[6].data1"></label><span>天的记录，且该条件发生后，至少有</span>
      <label><input class="PostDays num-input"
               type="number"
               min="0"
               v-model="form.formdetail[6].data2"></label>
      <span>天的记录。</span></div>
    <!-- 次要条件时间窗、概念限制 -->
    <div class="limit-condition"
         slot="footer"
      ...
      <label><input class="num-input"
               type="number"
               min="0"
               v-model="form.formdetail[6].data1"></label>天和之后
      <label><input class="num-input"
               type="number"
               min="0"
               v-model="form.formdetail[6].data2"></label>天
      <span class="occurrence-choose">，且集合内
        <select class="occurrence-select"
                value="2"
                v-model="form.formdetail[7].data1">
        ...
        <input class="occurrence-input"
               ...
               min="0"
               value="1"
               v-model="form.formdetail[7].data2">种
        <select value="0"
                class="occurrence-distinct"
                v-model="form.formdetail[7].data3">
...
export default {
  ...
  watch: {
    ...
    form: {
      handler() {
        //限制条件
        if (this.mainCondId != undefined && (this.form.formdetail[6].data1 != '' || this.form.formdetail[6].data2 != '')) {
          this.form.formdetail[6].layer1SortNo = this.mainCondId.id
          this.form.formdetail[6].criteriaTypeCode = "1"
          this.form.formdetail[6].typeSortNo = 1
          this.form.formdetail[6].layer2SortNo = 7
        } else if (this.minorCondId != undefined && (this.form.formdetail[6].data1 != '' || this.form.formdetail[6].data2 != '')) {
          console.log('dd')
        ...
        if (this.minorCondId != undefined && this.form.formdetail[7].data2 != '') {
