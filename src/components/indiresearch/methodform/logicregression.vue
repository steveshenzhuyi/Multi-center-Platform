<template>
  <div>
    <el-form :model="logicForm"
             ref="logicForm"
             label-width="100px">
      <el-form-item prop="methodname"
                    label="模型名称"
                    :rules="[{required: true, message: '请输入模型名称', trigger: 'blur' }]">
        <el-input v-model="logicForm.methodname"
                  size="mini"
                  style="width:200px;"></el-input>
      </el-form-item>
    </el-form>
    <!-- <el-row style="margin-top:10px;margin-bottom:10px">
      模型名称: &nbsp;<el-input v-model="logicForm.methodname"
                size="mini"
                style="width:200px;"></el-input>
    </el-row> -->
    <el-row :gutter="20">
    ...
    <el-row style="margin-top:10px;margin-bottom:10px">
      ...
      <fieldset class="groupbox-boarder">
        ...
        <el-col :span="8">
          <el-checkbox-group v-model="logicForm.parameters">
            <el-row>
        ...
        <el-col :span="8">
          精度基准 &nbsp;&nbsp;<el-input v-model="logicForm.precision"
                    type="number"
                    size="mini"
    ...
    <el-row style="margin-top:10px;margin-bottom:10px">
      ...
      <fieldset class="groupbox-boarder">
        ...
        <el-row>正规化
          <el-select v-model="logicForm.normalization"
                     size="mini">
        ...
        <el-row style="margin-top:10px;margin-bottom:10px">
          惩罚因子C <el-input type="number"
                    v-model="logicForm.penaltyfactor"
                    size="mini"
                    :precision="1"
                    :step="0.1"
